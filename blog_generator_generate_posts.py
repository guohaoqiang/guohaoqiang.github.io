...
<head>
  ...
  <style>
    ...
    .avatar-blur img{{position:relative;z-index:1}}
    .avatar-blur::after{{content:'';position:absolute;top:0;left:0;right:0;bottom:0;background:inherit;filter:blur(8px);border-radius:6px;z-index:10}}
  </style>
</head>
<body>
